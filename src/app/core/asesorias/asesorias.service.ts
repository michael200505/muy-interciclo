...
export class AsesoriaService {
  ...
  async requestAsesoria(data: Omit<Asesoria, 'id' | 'status' | 'createdAt'>): Promise<void> {
  ...
  // Obtener asesorías por programador (para el panel del programador)
  ...
  // Obtener asesorías por usuario (para "Mis asesorías")
  ...
  async updateStatus(id: string, status: AsesoriaStatus, response?: string): Promise<void> {
